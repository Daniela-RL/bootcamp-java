...
public class Main {
    ...
    private static List<Ingrediente> getIngredientes() {
        ...
        List<Ingrediente> ingredients = List.of(ingrediente, ingrediente2, ingrediente3);
        return ingredients;
    }
    ...
    private static String getDateFormat(){
        ...
        String requiredDate = dt.format(new Date());
        return requiredDate;
    ...
    public static void main(String[] args) {
        ...
        Pizzeria pizzeria = new Pizzeria(ingredientes);
        Pedido pedido = getPedido1();
        Pedido pedido2 = getPedido2();

        Scanner scanner = new Scanner(System.in);
        System.out.println("Date of order: " + getDateFormat());
        System.out.println("Options : ");
        System.out.println("    0. Exit");
        System.out.println("    1. See ingredients");
        System.out.println("    2. Create order 1");
        System.out.println("        Pizza 1: " + getPizza1().getUsedIngredientsStr(ingredientes));
        System.out.println("        Pizza 2: " + getPizza2().getUsedIngredientsStr(ingredientes));
